...
class DijkstraSimpleTest {
    ...
    void resolve10000_1() {
        ...
        var result = new DijkstraSimple(graph, 0, 10).resolve().getPath();
        Integer[] expected = {0,2713,1493,2803,5425,8614,5559,7807,2675,7625,4870,440,9701,3373,6699,8453,7202,7877,
    ...
    void resolve10000_2() {
        ...
        Integer[] expected = {0,2713,1493,2803,504,9732,7480,9715,8393,8381,4396,6242,5846,6243,9999};
    ...
    void resolve50000_1() {
        ...
        Integer[] expected = {0, 43305, 9788, 32, 46905, 28169, 5741, 33907, 9434, 15960, 39650, 33107, 16840, 35459,
